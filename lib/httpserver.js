...
class HTTPServer extends events.EventEmitter {
    ...
    init () {
        ...
        // Store passport instance in registry
        applicationFacade.registry.push('nodejs-lib-passport-instance', passport);
                ...
                for (var i = 0; i < httpMethods.length; i++) {
                    ...
                    if (controller.controllerHandler != null && typeof(controller.controllerHandler) == "function") {
                        ...
                        controllerHandler = function(request, response) {
                            ...
                            var controllerInstance = new ControllerClassDef(request, response);
