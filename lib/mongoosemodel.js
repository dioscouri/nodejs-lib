...
class MongooseModel extends Model {
    ...
    getListFiltered (filters, populations, pagination, sorting, callback) {
        ...
        if(filters.relation && filters.relation.fieldName && filters.relation.fieldValue) {
            relationFilter = {};
            relationFilter[filters.relation.fieldName] = filters.relation.fieldValue;
        }
        ...
        if(searchFilters && !relationFilter) {
            mongoFilters = searchFilters;
        } else if (!searchFilters && relationFilter) {
            mongoFilters = relationFilter;
        } else if (searchFilters && relationFilter) {
            mongoFilters.$and = [];
