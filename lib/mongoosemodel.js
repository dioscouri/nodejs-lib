...
class MongooseModel extends Model {
    ...
    registerSchema (schemaObject, listName) {
        ...
        this.schema.post('save', instance => {
            ...
            if (this._validationPending.indexOf(instance.id) > 0) {
                console.log('Item validation is pending: ' + instance.id);
                return; // Validation is pending
            }

            console.log(this._validationPending);

            console.log('Item validation queued: ' + instance.id);
            ...
            setTimeout(() => {
                ...
                this.validateInstance(instance, () => {
                    ...
                    console.log('Item validation finished: ' + instance.id);
                });
            }, 5000);
        });
    }
