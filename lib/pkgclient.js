...
class PkgClient {
    ...
    /**
     * Remove file from Container or Share
     *
     * @param containerOrShareName {string}
     * @param fileName {string}
     * @param callback
     */
    removeFile(containerOrShareName, fileName, callback) {

        if (this.clientConfig.provider === 'azure' && this.clientConfig.azureStorageType === 'fileStorage') {

            this.azureRemoveFile(containerOrShareName, fileName, callback);

        } else {

            this.blobRemoveFile(containerOrShareName, fileName, callback);
        }
    }

    /**
     * Remove file from BLOB container
     *
     * @param containerName {string}
     * @param fileName {string}
     * @param callback
     */
    blobRemoveFile(containerName, fileName, callback) {

        this.client.removeFile(containerName, fileName, callback);
    }

    /**
     * Remove file from Azure File Storage
     *
     * @param shareName {string}
     * @param fileName {string}
     * @param callback
     */
    azureRemoveFile(shareName, fileName, callback) {

        this.client.deleteFile(shareName, '', fileName, callback);
    }
}
