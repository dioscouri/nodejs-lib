...
class Mailer {
    ...
    constructor () {
         ...
         * @private
         */
        this._config = require('../app/models/common/configuration');
         ...
         * @private
         */
        this._mandrill = new (require('mandrill-api/mandrill')).Mandrill(this._config.conf[0].mandrill.apiKey);
    ...
    send(recipient, message, opts, callback, callbackError){
        ...
        var from = {
            'name' : this._config.conf[0].mandrill.fromName,
            'email' : this._config.conf[0].mandrill.fromEmail
        };
