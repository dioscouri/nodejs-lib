    ...
    render (response, request) {
        ...
        if (this.error == null) {
            ...
            if (this.viewType == ViewType.HTML) {
                ...
                if (this.data.state) {
                    //this.data.state = JSON.parse( CircularJSON.stringify( this.data.state ) );
                }
            ...
            if (response != null) {
                ...
                } else if (this.viewType == ViewType.HTML) {
                    this._logger.debug('@@ Loading HTML View: %', this.template);
