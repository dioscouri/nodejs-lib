...
class BaseCRUDController extends StateController {
    ...
    xlsExport(readyCallback) {
        ...
        let stream = this.getStreamFiltered(this.getViewFilters(), null, {});

        // let tmpFilePath = path.resolve(require('os').tmpdir(), `export_${(new Date()).getTime()}.xlsx`);
    ...
    /**
     * Export items to Excel file (deprecated)
     *
     * @param readyCallback
     */
    xlsExportOld(readyCallback) {
